  ...
  return (
    <StyledPrivacyPolicyContainer>
      ...
      <section>
        ...
        <br />
        <p>
          비어에어(이하 ‘회사’라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘서비스’)를 이용하는
          개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법,
          정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’) 등 관련 법령을
          준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록
          하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
        </p>
        <br />
        <br />
        <br />
        ...
        <p>
          ...
          등에 의해 적법하게 강제되는 경우 회사는 수집한 이용자의 개인정보를 사전에 개인의 동의 없이
          제3자에게 제공할 수도 있습니다.
        </p>
        <br />
        <br />
...
3. 회사는 제2항의 공지는 본 방침 개정의 시행일로부터 최소 7일 이전에 공지합니다. 다만, 이용자 권리의 중요한 변경이 있을 경우에는 최소 30일 전에 공지합니다.`}
        ...
        <br />
        <br />
        <h1>제4조 (회원 가입을 위한 정보)</h1>
        <br />
        <p>1. 필수 수집 정보: 이메일 주소, 이름, 닉네임</p>
        <br />
        <br />
        <br />
        <h1>제5조 (회사 서비스 제공을 위한 정보)</h1>
        <br />
        <p>
          회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다. 1. 필수
          수집 정보: 이메일 주소, 이름
        </p>
        <br />
        <br />
        <br />
        <h1>제6조(서비스 이용 및 부정 이용 확인을 위한 정보)</h1>
        <br />
        <p>
...
8. 법령 및 회사 약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재를 위한 경우`}
        ...
        <br />
        <br />
        <h1>제11조 (사전동의 등에 따른 개인정보의 제공)</h1>
        <br />
        <p>
...
2. 전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용 방지를 위하여 회원 탈퇴 시점으로부터 최대 1년간 보관합니다.`}
        ...
        <br />
        <br />
        <h1>제13조(법령에 따른 개인정보의 보유 및 이용기간)</h1>
        <br />
        <p>
...
4. 위치정보의 보호 및 이용 등에 관한 법률
    1. 개인위치정보에 관한 기록 : 6개월`}
        ...
        <br />
        <br />
        <h1>제15조 (서비스 미이용자에 대한 개인정보처리)</h1>
        <br />
        <p>
...
3. 이용자는 전자우편주소, 비밀번호 등에 대한 보안을 유지할 책임이 있으며 제3자에게 이를 양도하거나 대여할 수 없습니다.`}
        ...
        <br />
        <br />
        <h1>제20조 (회사의 개인정보 관리)</h1>
        <br />
        <p>
          회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조, 훼손 등이 되지
          아니하도록 안전성을 확보하기 위하여 다음과 같이 기술적·관리적 보호대책을 강구하고
          있습니다.
        </p>
        <br />
        <br />
        <br />
        <h1>제21조 (삭제된 정보의 처리)</h1>
        <br />
        <p>
        ...
        <p>
          ...
          훼손되는 것을 막기 위해 최선을 다하고 있습니다.회사는 최신 백신프로그램을 이용하여
          이용자들의 개인정보나 자료가 유출 또는 손상되지 않도록 방지하고 있습니다.회사는 민감한
          개인정보(를 수집 및 보유하고 있는 경우)를 암호화 통신 등을 통하여 네트워크상에서
          개인정보를 안전하게 전송할 수 있도록 하고 있습니다.
        </p>
        <br />
        <br />
        <br />
        <h1>제23조 (개인정보 유출 등에 대한 조치)</h1>
        <br />
        <p>
...
5. 이용자가 상담 등을 접수할 수 있는 부서 및 연락처
    1. 회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한 사유가 있는 경우에는 회사의 홈페이지에 30일 이상 게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수 있습니다.`}
        ...
        <br />
        <p>이 방침은 2022년 07월 02일부터 적용됩니다.</p>
        <br />
      </section>
    </StyledPrivacyPolicyContainer>
  );
