...
import { getBeer, getTop3BeerFlavor, getRecordsByBeer } from '@/apis';
...
const BeerDetailContainer = () => {
  ...
  const { data: recordsByBeerData } = useQuery(['recordByBeer', beerId], () =>
    getRecordsByBeer(payload),
  );
